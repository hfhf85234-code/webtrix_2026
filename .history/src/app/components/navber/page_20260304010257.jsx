...
export default function Navbar() {
  ...
  return (
    ...
    >
      {/* HEADER */}
      <div className="relative h-[76px] flex items-center justify-between px-[16px]">
       ...
       <h1 className="text-[#666666] text-[10px] lg:text-[14px] md:text-[14px]">Hey! Welcome back</h1>
        ...
        className="py-[8px] px-[18px]   transition-colors  text-white text-[16px] font-medium">
                      {open ? "X" : (<img src="navber/container.svg" />)}
