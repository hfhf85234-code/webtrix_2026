      ...
      <div className="relative h-[56px] flex items-center justify-between px-[16px]">
        ...
        <div className="flex items-center gap-4">
          <img
            src="/test.png"
            alt="logo"
            className="h-[46px] rounded-full shadow-md"
          />
  
          <button
            onClick={toggleMenu}
            className="py-[8px] px-[14px] bg-gray-800 hover:bg-gray-700 transition-colors rounded text-white text-[16px] font-medium"
          >
            {open ? "Close" : "Menu"}
          </button>
        </div>
        ...
        {/* RIGHT SIDE (Join) */}
        <button className="py-[8px] px-[18px] bg-blue-700 hover:bg-blue-600 transition-colors rounded text-white text-[16px] font-medium">
          Join
        </button>
