...
export default function Head() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Animate the horizontal logos at the bottom
      if (logodRef.current) {
      ...
      // Split text animations for title and paragraph
      ...
      // Continuous scroll animations for columns
      gsap.to(".scroll-up", {
        yPercent: -50,
        duration: 52,
        ease: "linear",
  ...
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="absolute inset-0 flex flex-col items-center pt-24 sm:pt-32 md:pt-40 space-y-5 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24">
        ...
        {/* Scrolling Images */}
        <div ref={sectionRef} className="w-screen h-full px-2 md:px-16 lg:px-24 py-4">
              ...
              <div className="flex gap-6 -rotate-15 scale-110">
                ...
                <div className="flex flex-col gap-6 scroll-up">
                  {["img1","img2","img3","img1","img2","img3"].map((img,i)=>(
                    <img key={i} src={`/images/${img}.jpg`} className="img-style w-full h-full" />
                  ))}
                </div>
                {/** Column 2 */}
        ...
        <div className="bg-white w-screen py-4 overflow-hidden">
