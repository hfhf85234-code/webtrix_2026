        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="flex gap-6 rotate-[-15deg] scale-110">
            ...
            <div className="flex flex-col gap-6 scroll-up">
              <img src="/images/img1.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img2.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img3.jpg" className="img-style w-[100px] h-[100px]" />
              {/* duplicate */}
              <img src="/images/img1.jpg" className="img-style w-[200px] h-[100px]" />
              <img src="/images/img2.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img3.jpg" className="img-style w-[100px] h-[100px]" />
            </div>
            ...
            <div className="flex flex-col gap-6 scroll-down">
              <img src="/images/img4.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img5.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img6.jpg" className="img-style w-[100px] h-[100px]" />
              {/* duplicate */}
              <img src="/images/img4.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img5.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img6.jpg" className="img-style w-[100px] h-[100px]" />
            ...
            {/* Column 3 */}
            <div className="flex flex-col gap-6 scroll-up">
              <img src="/images/img7.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img8.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img9.jpg" className="img-style w-[100px] h-[100px]" />
              {/* duplicate */}
              <img src="/images/img7.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img8.jpg" className="img-style w-[100px] h-[100px]" />
              <img src="/images/img9.jpg" className="img-style w-[100px] h-[100px]" />
