...
export default function Head() {
  ...
  return (
    ...
    <div className="w-full mt-4 overflow-hidden relative h-12 sm:h-16 md:h-20">
  <div
    ref={logodRef}
    className="flex  gap-[50px] lg:gap-[150px] md:gap-[100px] w-max items-center "
  >
    {/* Logos */}
    <img src="/subscriptions/logo1.svg" className="h-6 sm:h-8 md:h-10 w-auto" />
    <img src="/subscriptions/logo2.svg" className="h-6 sm:h-8 md:h-10 w-auto" />
    <img src="/subscriptions/logo3.svg" className="h-6 sm:h-8 md:h-10 w-auto" />
    <img src="/subscriptions/logo4.svg" className="h-6 sm:h-8 md:h-10 w-auto" />
    <img src="/subscriptions/logo6.svg" className="h-6 sm:h-8 md:h-10 w-auto" />

    <img src="/subscriptions/logo5.svg" className="h-6 sm:h-8 md:h-10 w-auto" />
    {/* Duplicate */}
    <img src="/subscriptions/logo1.svg" className="h-6 sm:h-8 md:h-10 w-auto" />
    <img src="/subscriptions/logo2.svg" className="h-6 sm:h-8 md:h-10 w-auto" />
    <img src="/subscriptions/logo3.svg" className="h-6 sm:h-8 md:h-10 w-auto" />
