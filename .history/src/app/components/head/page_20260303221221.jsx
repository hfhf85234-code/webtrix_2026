  ...
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="absolute inset-0 flex flex-col items-center pt-24 sm:pt-32 md:pt-40 space-y-5 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24">
        ...
        <div className="w-screen h-full px-[100px] p-[10px]">
        <div className="bg-[#F8F8F8] w-full h-[600px] rounded-[30px] overflow-hidden relative p-6">
  <div className="absolute inset-0 flex items-center justify-center">
    <div className="flex gap-6 rotate-[35deg] scale-110">
      
      {/* Column 1 */}
      <div className="space-y-6">
        <img
          src="/images/img1.jpg"
          className="w-[220px] h-[160px] rounded-xl object-cover shadow-lg"
        />
        <img
          src="/images/img2.jpg"
          className="w-[220px] h-[160px] rounded-xl object-cover shadow-lg"
