  ...
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="absolute inset-0 flex flex-col items-center pt-24 sm:pt-32 md:pt-40 space-y-5 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24">
        ...
        <div className="bg-[#F8F8F8] w-full h-full rounded-[30px] overflow-hidden p-4">
  <div className="flex gap-[10px] rotate-[40deg]">
    <div className="space-y-[10px]">
      <div className="bg-black w-[130px] h-[100px]"></div>
      <div className="bg-black w-[130px] h-[100px]"></div>
      <div className="bg-black w-[130px] h-[100px]"></div>
    </div>
