  ...
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="absolute inset-0 flex flex-col items-center pt-24 sm:pt-32 md:pt-40 space-y-5 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24">
        ...
        <div className="bg-[#F8F9FA] py-2 px-3 sm:px-4 border border-[#E6E9EE] rounded-full text-center">
          <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-3">
            ...
            {/* Join button */}
            <button className="bg-[#c4fc5a] text-[#262626] text-[10px] sm:text-[12px] px-2 sm:px-3 py-1 rounded-full whitespace-nowrap">
              Join Waitlist
            </button>
          </div>
        </div>
