...
reconciliation, and detailed analytics.</p>
            ...
            <div className="w-full h-full px-1 p-1">
            <img className="absolute z-1  h-full" src="/imagesProject/img1.jpg" alt="project1" />
            <img className=" absolute z-2  h-full" src="/imagesProject/img1.jpg" alt="project1" />
            <img className="absolute z-3  h-full" src="/imagesProject/img1.jpg" alt="project1" />
            <img className="absolute z-4  h-full" src="/imagesProject/img1.jpg" alt="project1" />
            <img className="absolute z-5  h-full" src="/imagesProject/img1.jpg" alt="project1" />
            <img className="absolute z-6  h-full" src="/imagesProject/img1.jpg" alt="project1" />
            </div>
