      ...
      <div className="bg-[#8CEF6C] w-full h-full rounded-[24px] px-[40px] p-[40px]">
        <div className="flex gap-1">
          ...
          <div className="relative w-full h-[400px] px-2 py-2">
            <img className="absolute  card  left-10 w-[90%] rounded-[10px] shadow-lg"
              src="/imagesProject/img1.jpg" alt="project1" />
            <img className="absolute card  left-20 w-[90%] rounded-[10px] shadow-lg"
              src="/imagesProject/img2.jpg" alt="project2" />
            <img className="absolute card  left-30 w-[90%] rounded-[10px] shadow-lg"
              src="/imagesProject/img3.jpg" alt="project3" />
            <img className="absolute card  left-40 w-[90%] rounded-[10px] shadow-lg"
              src="/imagesProject/img4.jpg" alt="project4" />
            <img className="absolute card  left-50 w-[90%] rounded-[10px] shadow-lg"
              src="/imagesProject/img5.jpg" alt="project5" />
            <img className="absolute card  left-60 w-[90%] rounded-[10px] shadow-lg"
              src="/imagesProject/img6.jpg" alt="project6" />
            <img className="absolute card  left-70 w-[90%] rounded-[10px] shadow-lg"
