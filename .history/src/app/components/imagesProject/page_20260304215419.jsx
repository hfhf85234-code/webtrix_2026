...
reconciliation, and detailed analytics.</p>
  ...
  <img className="absolute top-5 left-0 rounded-[10px] z-20" src="/imagesProject/img2.jpg" alt="project1" />
  <img className="absolute top-10 left-0 rounded-[10px] z-30" src="/imagesProject/img3.jpg" alt="project1" />
  <img className="absolute top-15 left-0 rounded-[10px] z-40" src="/imagesProject/img4.jpg" alt="project1" />
</div>
            <div className=" flex justify-end w-full h-full px-1 p-1">
                <div className="bg-[#3C3C3C] w-[265px] h-[678px]"></div>
            </div>
