...
reconciliation, and detailed analytics.</p>
  ...
  <img className="absolute top-5 left-0 rounded-[10px] z-20" src="/imagesProject/img1.jpg" alt="project1" />
  <img className="absolute top-10 left-0 rounded-[10px] z-30" src="/imagesProject/img1.jpg" alt="project1" />
  <img className="absolute top-15 left-0 rounded-[10px] z-40" src="/imagesProject/img1.jpg" alt="project1" />
</div>
