...
reconciliation, and detailed analytics.</p>
  ...
  <img className="absolute top-20 left-0 rounded-[10px] z-50" src="/imagesProject/img5.jpg" alt="project5" />
  <img className="absolute top-25 left-0 rounded-[10px] z-60" src="/imagesProject/img6.jpg" alt="project5" />
  <img className="absolute top-30 left-0 rounded-[10px] z-70" src="/imagesProject/img7.jpg" alt="project7" />
</div>
