...
export default function Download() {
  return (
    <div className="w-screen min-h-screen bg-white p-[10px]">
      ...
      {/* pag2 */}
      <div className="w-full h-full px-[20px] py-[30px] md:px-[70px] md:py-[40px]">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[15px] justify-center">
    ...
    <div className="bg-[#FAFAFA] border border-[#f2f2f2] rounded-[22px] w-full h-full p-[20px] md:p-[25px]">
      ...
      <div className="space-y-1 pt-[40px] md:pt-[100px]">
        <h1 className="text-[26px] md:text-[38.3px] text-[#212121]">300M+</h1>
    ...
    <div className="bg-[#FAFAFA] border border-[#f2f2f2] rounded-[22px] w-full h-full p-[20px] md:p-[25px]">
      ...
      <div className="space-y-1 pt-[40px] md:pt-[100px]">
        <h1 className="text-[26px] md:text-[38.3px] text-[#212121]">20%</h1>
        <p className="text-[14px] md:text-[17.7px] text-[#757575]">
          Audience growth
        </p>
      </div>
    ...
    <div className="bg-[#FAFAFA] border border-[#f2f2f2] rounded-[22px] w-full h-full p-[20px] md:p-[25px]">
      ...
      <div className="space-y-1 pt-[40px] md:pt-[100px]">
        <h1 className="text-[26px] md:text-[38.3px] text-[#212121]">49%</h1>
        <p className="text-[14px] md:text-[17.7px] text-[#757575]">
          Growth in revenue
        </p>
      </div>
    ...
    <div className="bg-[#FAFAFA] border border-[#f2f2f2] rounded-[22px] w-full h-full p-[20px] md:p-[25px]">
      ...
      <div className="space-y-1 pt-[40px] md:pt-[100px]">
        <h1 className="text-[26px] md:text-[38.3px] text-[#212121]">500K+</h1>
        <p className="text-[14px] md:text-[17.7px] text-[#757575]">
          Creator & agencies
        </p>
      </div>
