...
<div className="w-full h-full px-[35px] p-[35px] ">
     <div className="bg-radial-[at_50%_-38%] from-white to-neutral-900 to 82%  w-full h-full rounded-[32px] ">
