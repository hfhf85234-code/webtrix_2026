        ...
        <div className="flex-1 bg-gradient-to-br from-white via-gray-700 to-neutral-900 rounded-2xl p-6 md:p-8 overflow-hidden">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6">
            ...
            <div className="flex-1 space-y-4">
              <h1 className="text-white text-2xl sm:text-2xl md:text-3xl font-semibold">
                Systems, SaaS, Apps Desktop
              </h1>
              <p className="text-gray-300 text-base sm:text-base md:text-lg">
                Get the desktop app for SAP's comprehensive project management tools
              </p>

              <div className="flex flex-col sm:flex-row gap-3 mt-4">
                <button className="bg-gray-600 hover:bg-gray-700 transition rounded-lg text-white py-3 px-5 text-sm sm:text-sm md:text-base shadow w-full sm:w-auto">
