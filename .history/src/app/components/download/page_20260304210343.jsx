...
export default function Download() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      counters.forEach((counter) => {
        ...
        // نحولو الرقم ل digits
        const digits = number.toString().split("");
  
        // نبنيو structure داخلي بدون تغيير الواجهة
        counter.innerHTML = "";
        ...
        gsap.to(
          { val: 0 },
          {
            ...
            scrollTrigger: {
              trigger: counter,
              start: "top 85%",
              toggleActions: "play none reset none", // repeat on scroll
            },
            onUpdate: function () {
  ...
  return (
    <div className="w-screen min-h-screen bg-white px-[130px] p-[10px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[15px] justify-center">
          ...
          <div className="bg-[#FAFAFA] border border-[#f2f2f2] rounded-[22px] w-full h-full p-[20px] md:p-[25px]">
            ...
            <div className="space-y-1 pt-[40px] md:pt-[100px]">
              <h1 className="counter text-[26px] md:text-[38.3px] text-[#212121]">400M+</h1>
