  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      counters.forEach((counter) => {
        const finalNumber = parseInt(counter.dataset.target);
        let current = 0;
  
        // نهيكلو HTML بحال node0/node1
        counter.innerHTML = `
        ...
        function updateDigit(value) {
          ...
          gsap.to([currentEl, nextEl], {
            ...
            onComplete: () => {
              ...
              gsap.set([currentEl, nextEl], { y: "-=100%" });
            },
          });
        }
        ...
        gsap.to(
          { val: 0 },
          {
            ...
            onUpdate: function () {
              const newValue = Math.floor(this.targets()[0].val);
