...
export default function Download() {
  return (
    <div className="w-screen min-h-screen bg-white p-[10px]">
      ...
      {/* pag2 */}
      <div  className="w-full h-full px-[70px] p-[40px]">
        <div className="flex gap-[10px] justify-center">
        <div className="bg-[#FAFAFA] border border-[#f2f2f2] rounded-[22px] w-full  h-full px-[20px] p-[20px]">

          <img className="flex justify-start" src="download/icon1.svg" alt="" />
          <div className="space-y-1 pt-[100px]">
          <h1 className="text-[38.3px] text-[#212121]">300M+</h1>
          <p className="text-[17.7px] text-[#757575]">Total views generated</p>
...
<img className="flex justify-start" src="download/icon2.svg" alt="" />
<div className="space-y-1 pt-[100px]">
<h1 className="text-[38.3px] text-[#212121]">20%</h1>
<p className="text-[17.7px] text-[#757575]">Audience growth</p>
...
<img className="flex justify-start" src="download/icon3.svg" alt="" />
<div className="space-y-1 pt-[100px]">
<h1 className="text-[38.3px] text-[#212121]">49%</h1>
<p className="text-[17.7px] text-[#757575]">Growth in revenue</p>
...
<img className="flex justify-start" src="download/icon4.svg" alt="" />
<div className="space-y-1 pt-[100px]">
<h1 className="text-[38.3px] text-[#212121]">500K+</h1>
<p className="text-[17.7px] text-[#757575]">Creator & agencies</p>
