...
export default function Download() {
  ...
  return (
   <div className="w-screen h-screen  bg-white px-[10px] p-[10px]">
...
<img class="justify-end z-100 ml-[37px] mt-[50px] object-cover" src="download/saas.png" alt="" />
     ...
     <div className="bg-radial-[at_50%_-38%] from-white to-neutral-900 to 82%  w-full h-full rounded-[32px]  px-[35px] p-[35px] overflow-hidden  ">
       <div className=" flex justify-start">
         ...
         <p className="text-[#B3B3B3]  w-[541.26px] text-[18px]">Download the ultimate mobile app for SAP's project management 
on-the-go.</p>
...
<img class=" flex justify-center   object-cover" src="download/appmobile.png" alt="" />
