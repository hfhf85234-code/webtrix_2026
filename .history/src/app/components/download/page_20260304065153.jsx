          ...
          <div className="flex flex-col h-full">
            <div className="space-y-[10px]">
              ...
              <div className="flex flex-wrap gap-[10px] mt-[10px]">
                ...
                <button className="flex gap-2 mt-1 bg-[#666666] hover:bg-[#777777] transition-colors rounded-[10px] text-white shadow text-[14px] md:text-[16px] py-3 px-4 md:py-4 md:px-4">
                  Download For
